...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookPro'
        db.create_table(u'eshopper_bookpro', (
        ...
        db.send_create_signal(u'eshopper', ['BookPro'])


    def backwards(self, orm):
        # Deleting model 'BookPro'
        db.delete_table(u'eshopper_bookpro')
    ...
    models = {
        ...
        u'eshopper.bookpro': {
            'Meta': {'object_name': 'BookPro', '_ormbases': ['shop.Product']},
